...
const copy = {
  en: {
    ...
    links: [
      ...
      { title: "GA Tax Calculator", sub: "Form 500 step-by-step", badge: "New", href: "/tax-calculator" },
    ],
  ...
  es: {
    ...
    links: [
      ...
      { title: "Calculadora de Impuestos GA", sub: "Form 500 paso a paso", badge: "Nuevo", href: "/tax-calculator" },
    ],
