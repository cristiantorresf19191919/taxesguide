  ...
  return (
        ...
        >
          ...
          <Section title={isEn ? "Complete startup cost breakdown" : "Desglose completo de costes de arranque"}>
            ...
            />
            <p>{isEn ? <>The most realistic first-year budget for Sandra is <strong className="text-amber-600 dark:text-amber-300">$3,000–$5,000</strong>, covering essentials plus adequate software and marketing.</> : <>El presupuesto más realista para el primer año de Sandra es <strong className="text-amber-600 dark:text-amber-300">$3,000–$5,000</strong>, cubriendo lo esencial más software y marketing adecuados.</>}</p>
          </Section>

          <Section title={isEn ? "Choosing the right tax software" : "Elegir el software de impuestos adecuado"}>
            <p>{isEn ? <>For Sandra&apos;s first season, <strong className="text-amber-600 dark:text-amber-300">Drake Tax Pay-Per-Return at $349.99</strong> (10 returns, full features) is the strongest recommendation. Drake is #1 among sole-proprietor preparers (2024 Tax Adviser Survey), includes all federal and state forms with no per-state surcharges, and has strong support. At 50+ returns, Drake Unlimited (~$1,875–$1,995) makes sense.</> : <>Para la primera temporada de Sandra, <strong className="text-amber-600 dark:text-amber-300">Drake Tax Pay-Per-Return a $349.99</strong> (10 declaraciones, funciones completas) es la recomendación más fuerte. Drake es #1 entre preparadores individuales (Encuesta Tax Adviser 2024), incluye todos los formularios federales y estatales sin recargos por estado y tiene buen soporte. Con 50+ declaraciones, Drake Unlimited (~$1,875–$1,995) tiene sentido.</>}</p>
          ...
          <Section title={isEn ? "What to charge and how to find clients" : "Qué cobrar y cómo encontrar clientes"}>
            ...
            <p>{isEn ? <>Realistic first season (part-time solo): <strong className="text-amber-600 dark:text-amber-300">30–75 returns</strong>. Second season: 75–150. Experienced full-time: 200–350. At $250/return average, 75 returns ≈ <strong className="text-amber-600 dark:text-amber-300">$18,750</strong> first season.</> : <>Primera temporada realista (tiempo parcial solo): <strong className="text-amber-600 dark:text-amber-300">30–75 declaraciones</strong>. Segunda temporada: 75–150. Experimentados a tiempo completo: 200–350. A $250/declaración promedio, 75 declaraciones ≈ <strong className="text-amber-600 dark:text-amber-300">$18,750</strong> primera temporada.</>}</p>
          </Section>
