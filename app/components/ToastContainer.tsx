...
const STYLES: Record<ToastType, { bg: string; border: string; icon: string }> = {
  success: { bg: "bg-emerald-50 dark:bg-emerald-500/15", border: "border-emerald-200 dark:border-emerald-500/30", icon: "check-circle" },
  info:    { bg: "bg-blue-50 dark:bg-blue-500/15",    border: "border-blue-200 dark:border-blue-500/30",    icon: "info" },
  warning: { bg: "bg-amber-50 dark:bg-amber-500/15",   border: "border-amber-200 dark:border-amber-500/30",   icon: "alert" },
  error:   { bg: "bg-red-50 dark:bg-red-500/15",     border: "border-red-200 dark:border-red-500/30",     icon: "x-circle" },
};
