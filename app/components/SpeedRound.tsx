    ...
    return (
      ...
      >
        <div className="mb-4 flex items-center gap-3">
          <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-2xl bg-gradient-to-br from-violet-500/15 to-indigo-500/15 text-xl dark:from-violet-500/20 dark:to-indigo-500/20">
            ⚡
          </div>
          <div className="min-w-0 flex-1">
            ...
            <span className="text-[10px] font-semibold text-violet-500/80">
              {isEn ? "Timed Challenge" : "Contrarreloj"}
            </span>
          </div>
        </div>
        <p className="mb-4 text-xs leading-relaxed text-slate-500 dark:text-neutral-400">
          {isEn
            ? `${ROUND_SECONDS}s to answer as many as you can. Build combos for x2, x3, x4 XP!`
            : `${ROUND_SECONDS}s para responder todos los que puedas. ¡Combos para x2, x3, x4 XP!`}
        </p>
        {state.speedRoundBest > 0 && (
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.97 }}
          className="w-full rounded-xl bg-gradient-to-r from-violet-500 to-indigo-500 py-3.5 text-sm font-bold text-white shadow-lg shadow-violet-500/25 transition-shadow hover:shadow-violet-500/35"
        >
