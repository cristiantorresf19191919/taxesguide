...
const ALIASES: Record<string, string[]> = {
  ...
  aotc: ["AOTC", "American Opportunity Tax Credit", "American Opportunity"],
  hoh: ["HOH", "Head of Household", "head of household"],
  mfj: ["MFJ", "Married Filing Jointly", "married filing jointly"],
  "w-4": ["W-4", "Form W-4"],
  "w-12": ["W-12", "Form W-12"],
  natp: ["NATP"],
  nsa: ["NSA"],
  ...
  "form-500": ["Form 500", "Georgia Form 500"],
  "id-me": ["ID.me"],
  "refundable-credit": ["Refundable credit", "refundable credit", "non-refundable"],
  "gross-receipts": ["gross receipts", "Gross Receipts", "gross revenue"],
  "pass-through": ["pass-through taxation", "Pass-through", "pass-through"],
