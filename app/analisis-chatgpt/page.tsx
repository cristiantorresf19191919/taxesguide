    ...
    >
      <motion.header variants={fadeUp} className="space-y-5">
        <div className="flex justify-center">
          <motion.div
            className="rounded-2xl bg-gradient-to-br from-emerald-500/25 to-teal-600/20 p-5 ring-1 ring-black/5 dark:ring-white/10"
      ...
      <Section title={isEn ? "Step 1: Get your PTIN (Preparer Tax Identification Number)" : "Paso 1: Obtener tu PTIN (Número de Identificación de Preparador)"}>
        ...
        <ul className="list-inside list-disc space-y-1 text-slate-600 dark:text-neutral-300">
          <li><strong className="text-slate-900 dark:text-white">{isEn ? "Where:" : "Dónde:"}</strong> {isEn ? "IRS Tax Professional PTIN System (irs.gov)" : "Sistema PTIN de Profesionales de Impuestos del IRS (irs.gov)"}</li>
          <li><strong className="text-slate-900 dark:text-white">{isEn ? "Cost:" : "Costo:"}</strong> $18.75/{isEn ? "year" : "año"}</li>
          <li><strong className="text-slate-900 dark:text-white">{isEn ? "Time:" : "Tiempo:"}</strong> {isEn ? "~15 minutes online; issued immediately" : "~15 minutos en línea; se emite inmediatamente"}</li>
          <li><strong className="text-slate-900 dark:text-white">{isEn ? "Identity verification:" : "Verificación de identidad:"}</strong> {isEn ? "ID.me (government-issued photo ID + selfie)" : "ID.me (identificación con foto emitida por el gobierno + selfie)"}</li>
          <li><strong className="text-slate-900 dark:text-white">{isEn ? "Renewal:" : "Renovación:"}</strong> {isEn ? "Annual — PTINs expire December 31; renewal window opens mid-October" : "Anual — los PTIN expiran el 31 de diciembre; la ventana de renovación abre a mediados de octubre"}</li>
          <li><strong className="text-slate-900 dark:text-white">{isEn ? "Paper option:" : "Opción en papel:"}</strong> {isEn ? "Form W-12 (takes ~6 weeks)" : "Formulario W-12 (tarda ~6 semanas)"}</li>
        </ul>
      ...
      <Section title={isEn ? "Step 2: Choose a training program" : "Paso 2: Elegir un programa de formación"}>
        ...
        <ul className="list-inside list-disc space-y-2 text-slate-600 dark:text-neutral-300">
          <li>
            <strong className="text-slate-900 dark:text-white">IRS VITA/TCE Program</strong> — {isEn
          ...
          <li>
            <strong className="text-slate-900 dark:text-white">IRS Publications</strong> — {isEn
        ...
        <ul className="list-inside list-disc space-y-2 text-slate-600 dark:text-neutral-300">
          <li>
            <strong className="text-slate-900 dark:text-white">H&R Block Income Tax Course:</strong> {isEn
          ...
          <li>
            <strong className="text-slate-900 dark:text-white">Jackson Hewitt Fundamentals:</strong> {isEn
        ...
        <ul className="list-inside list-disc space-y-2 text-slate-600 dark:text-neutral-300">
          <li>
            <strong className="text-slate-900 dark:text-white">Surgent Comprehensive Tax Course:</strong> {isEn
          ...
          <li>
            <strong className="text-slate-900 dark:text-white">{isEn ? "Georgia technical colleges:" : "Universidades técnicas de Georgia:"}</strong> {isEn
      ...
      <Section title={isEn ? "Step 3: Complete the AFSP (Annual Filing Season Program)" : "Paso 3: Completar el AFSP (Programa Anual de Temporada de Presentación)"}>
        ...
        <p className="font-medium text-slate-800 dark:text-white">{isEn ? "Requirements:" : "Requisitos:"}</p>
        <ul className="list-inside list-disc space-y-1 text-slate-600 dark:text-neutral-300">
          ...
          <li><strong className="text-slate-900 dark:text-white">{isEn ? "Cost:" : "Costo:"}</strong> {isEn ? "Typically $100–$250 for a complete AFSP CE bundle" : "Típicamente $100–$250 por un paquete completo de CE para AFSP"}</li>
          <li><strong className="text-slate-900 dark:text-white">{isEn ? "Deadline:" : "Fecha límite:"}</strong> {isEn ? "December 31 each year" : "31 de diciembre de cada año"}</li>
        </ul>
        <p>
          {isEn
      ...
      <Section title={isEn ? "Step 4: Apply for your EFIN (Electronic Filing Identification Number)" : "Paso 4: Solicitar tu EFIN (Número de Identificación de Presentación Electrónica)"}>
        ...
        <ul className="list-inside list-disc space-y-1 text-slate-600 dark:text-neutral-300">
          ...
          <li><strong className="text-slate-900 dark:text-white">{isEn ? "Processing time:" : "Tiempo de procesamiento:"}</strong> {isEn ? "Up to 45 days — apply well before tax season (ideally October–November)" : "Hasta 45 días — solicitar mucho antes de la temporada de impuestos (idealmente octubre–noviembre)"}</li>
          <li><strong className="text-slate-900 dark:text-white">{isEn ? "Process:" : "Proceso:"}</strong> {isEn ? "Create IRS e-Services account → submit e-file application (Electronic Return Originator) → complete fingerprinting via IRS-authorized Livescan" : "Crear cuenta en e-Services del IRS → enviar solicitud de e-file (Electronic Return Originator) → completar toma de huellas vía Livescan autorizado por el IRS"}</li>
      ...
      <Section title={isEn ? "Step 5: Set up your business in Georgia" : "Paso 5: Establecer tu negocio en Georgia"}>
        ...
        <p className="mt-4 font-medium text-emerald-600 dark:text-emerald-300"><GlossaryTerm id="ein" lang={lang}>EIN</GlossaryTerm> ({isEn ? "Employer Identification Number" : "Número de Identificación del Empleador"})</p>
      ...
      <Section title={isEn ? "Month-by-month launch timeline" : "Cronograma de lanzamiento mes a mes"}>
        <div className="space-y-6">
          <Card>
            <div className="font-semibold text-emerald-600 dark:text-emerald-300">{isEn ? "June–July: Foundation" : "Junio–Julio: Base"}</div>
          ...
          <Card>
            <div className="font-semibold text-emerald-600 dark:text-emerald-300">{isEn ? "August–September: Structured training" : "Agosto–Septiembre: Formación estructurada"}</div>
            <p className="mt-2">{isEn
          ...
          <Card>
            <div className="font-semibold text-emerald-600 dark:text-emerald-300">{isEn ? "October: Credentialing" : "Octubre: Acreditación"}</div>
            <p className="mt-2">{isEn
          ...
          <Card>
            <div className="font-semibold text-emerald-600 dark:text-emerald-300">{isEn ? "November: Business setup" : "Noviembre: Configuración del negocio"}</div>
            <p className="mt-2">{isEn
          ...
          <Card>
            <div className="font-semibold text-emerald-600 dark:text-emerald-300">{isEn ? "December: AFSP and marketing launch" : "Diciembre: AFSP y lanzamiento de marketing"}</div>
            <p className="mt-2">{isEn
          ...
          <Card>
            <div className="font-semibold text-emerald-600 dark:text-emerald-300">{isEn ? "January–April: First season" : "Enero–Abril: Primera temporada"}</div>
            <p className="mt-2">{isEn
          ...
          <Card>
            <div className="font-semibold text-emerald-600 dark:text-emerald-300">{isEn ? "May–October: Post-season growth" : "Mayo–Octubre: Crecimiento post-temporada"}</div>
            <p className="mt-2">{isEn
      ...
      <Section title={isEn ? "Building a client base from zero" : "Construir una base de clientes desde cero"}>
        <p className="font-medium text-slate-800 dark:text-white">{isEn ? "Three proven strategies:" : "Tres estrategias probadas:"}</p>
        <ul className="list-inside list-disc space-y-3 text-slate-600 dark:text-neutral-300">
          <li>
            <strong className="text-slate-900 dark:text-white">{isEn ? "Personal network:" : "Red personal:"}</strong> {isEn
          ...
          <li>
            <strong className="text-slate-900 dark:text-white">{isEn ? "Online presence:" : "Presencia en línea:"}</strong> {isEn
          ...
          <li>
            <strong className="text-slate-900 dark:text-white">{isEn ? "Community networking:" : "Networking comunitario:"}</strong> {isEn
